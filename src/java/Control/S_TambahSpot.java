 ...
 * @author GHOSTMAN
 */
@WebServlet(name = "S_TambahSpot", urlPatterns = {"/S_TambahSpot"})
public class S_TambahSpot extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet S_TambahSpot</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet S_TambahSpot at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
// Parse the request
            ...
            C_Spot.simpanSpot(spot);
            response.sendRedirect("View/TambahSpot.jsp");
